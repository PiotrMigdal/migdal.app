...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::factory()->create([
            ...
            'education' => 'Opole University of Technology, Bachelor of Logistics Engineering',
            'age' => 30,
            'main_job' => 'IT Support Enigneer',
            'additional_job' => ''
        ]);
        ...
        //     'excerpt' => 'Fugit tempore quidem ullam debitis ipsam maxime eos. Harum provident aut ipsum et nesciunt nihil aut. Et voluptatum delectus quasi soluta est nam sed vitae.',
        ...
        for ($i=2; $i <=20; $i++) {
            About::factory(rand(1,10))->create([
                'user_id' => $i,
            ]);
            Project::factory(rand(1,10))->create([
                'user_id' => $i,
            ]);
            Course::factory(rand(1,10))->create([
                'user_id' => $i,
            ]);
            Job::factory(rand(1,10))->create([
                'user_id' => $i,
            ]);
        }
